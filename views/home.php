    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="item active">
                <img src="<?= AppHelper::getBaseURL() ?>/movie.lk/imgs/Sarkar.jpg" alt="Los Angeles"
                     style="width:100%;">
            ...
            <div class="item">
                <img src="<?= AppHelper::getBaseURL() ?>/movie.lk/imgs/visuwasam.jpg" alt="New York"
                     style="width:100%;">
                <div class="carousel-caption">
                    <h3>New York</h3>
            ...
            <div class="item">
                <img src="<?= AppHelper::getBaseURL() ?>/movie.lk/imgs/aqua_man.jpg" alt="Los Angeles"
                     style="width:100%;">
                <div class="carousel-caption">
                    <h3>Los Angeles</h3>
                    <p>LA is always so much fun!</p>
