...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= AppHelper::getBaseURL() ?>/movie.lk/style/myCss.css">
        ...
        <div class="row">
            <div class="col">
                ...
                <a class="navbar-brand" href="#">
                    <img src="<?= AppHelper::getBaseURL() ?>/movie.lk/imgs/logo.png" alt="logo"
                ...
                <div class="text-right">
                    ...
                    <?php if (!empty($_SESSION)) {
                        ...
                        if (isset($_SESSION['user'])) { ?>
                            <h4><a href="<?= AppHelper::getBaseURL() ?>/movie.lk/process/logout.php">
                            ...
                            <h4><a href="<?= AppHelper::getBaseURL() ?>/movie.lk/index.php/login">
        ...
        <div class="row">
            <div class="col">
                <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top" id="remove-border-redius">
                    ...
                    <ul class="navbar-nav">
                        <li class="active">
                            <a class="nav-link active" href="<?= AppHelper::getBaseURL() ?>/movie.lk/index.php/home"><h3
                                        id="nav">HOME</h3></a>
                        </li>

                        <li>
                            <a class="nav-link" href="<?= AppHelper::getBaseURL() ?>/movie.lk/index.php/movies"><h3
                                        id="nav"> MOVIES</h3></a>
                        </li>
                        <li>
                            <a class="nav-link" href="<?= AppHelper::getBaseURL() ?>/movie.lk/index.php/theaters"><h3
